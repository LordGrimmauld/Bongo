...
public class StopCommand implements Command<CommandSource> {
    ...
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        Util.broadcast(player.getEntityWorld(), new TranslationTextComponent("bongo.info").appendSibling(player.getDisplayName()).appendSibling(new TranslationTextComponent("bongo.cmd.stop.done")));
